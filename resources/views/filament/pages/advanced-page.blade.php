<x-filament-panels::page>
 ...
 <div class="w-full p-4 bg-gray-500 shadow-lg" style="background-color: #51515163; border-radius: 20px; border: 5px solid; animation: border-color-animation 4s infinite;">
        <h2 class="mb-5 text-3xl">16 </h2>
        <p>Velocidade e Estabilidade inagualável! Compre direto pelo site: <a href="https://gator.drakon.casino" target="_blank" style="color: red;">s</a> Telegram: <a href="https://t.me/drakongator" target="_blank" style="color: red;">s</a></p>
        <br>
        <div class="flex justify-between w-full gap-4">
            <div class="flex flex-col gap-4 w-full justify-between">
                <button wire:click="loadProviderPgOnePlayiGaming" style="border-radius: 10px" class="bg-primary-600 px-3 py-2 w-full text-center">
                    <div wire:loading wire:target="loadProviderPgOnePlayiGaming">Carregando Provedores</div>
                    <div wire:loading.remove wire:target="loadProviderPgOnePlayiGaming">Carregar Provedores</div>
                </button>

            </div>
            <button wire:click="loadGamesPgOnePlayiGaming" style="border-radius: 10px; overflow: hidden; position: relative; background-color: #7f3cb9" class="bg-primary-500 px-3 py-2 w-full">
                <div class="flex flex-col gap-4 w-full justify-between">
                    <div wire:loading wire:target="loadGamesPgOnePlayiGaming">
                    ...
                    <div wire:loading.remove wire:target="loadGamesPgOnePlayiGaming">
                        Carregar Jogos
                    </div>
                </div>
            </button>
    ...
    <!-- CARREGAR JOGOS TBS-->
    <div class="w-full p-4 bg-gray-500 shadow-lg" style="background-color: #51515163; border-radius: 20px; border: 5px solid; animation: border-color-animation 4s infinite;">
        <h2 class="mb-5 text-3xl">TBS Russian </h2>
        <div class="flex justify-between w-full gap-4">
            <button wire:click="loadGamesPlayGaming" style="border-radius: 10px; overflow: hidden; position: relative; background-color: #7f3cb9" class="bg-primary-500 px-3 py-2 w-full">
                <div style="flex flex-col gap-4 w-full justify-between; color: #ffffff;">
                    <div wire:loading wire:target="loadGamesPlayGaming">
                        <div style="display: flex; align-items: center;">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display: block; shape-rendering: auto; animation-play-state: running; animation-delay: 0s; max-width: 32px; margin-right: 8px;" width="32px" height="32px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                                <path fill="none" stroke="#ffffff" stroke-width="8" stroke-dasharray="42.76482137044271 42.76482137044271" d="M24.3 30C11.4 30 5 43.3 5 50s6.4 20 19.3 20c19.3 0 32.1-40 51.4-40 C88.6 30 95 43.3 95 50s-6.4 20-19.3 20C56.4 70 43.6 30 24.3 30z" stroke-linecap="round" style="transform: scale(0.8); transform-origin: 50px 50px 0px; animation-play-state: running; animation-delay: 0s;">
                                    <animate attributeName="stroke-dashoffset" repeatCount="indefinite" dur="1s" keyTimes="0;1" values="0;256.58892822265625" style="animation-play-state: running; animation-delay: 0s;"></animate>
                    ...
                    <div wire:loading.remove wire:target="loadGamesPlayGaming">
                        Carregar Jogos
                    </div>
                </div>
            </button>
    ...
    <!-- CARREGAR JOGOS VOXELGATOR-->
    <div class="w-full p-4 bg-gray-500 shadow-lg" style="background-color: #51515163; border-radius: 20px; border: 5px solid; animation: border-color-animation 4s infinite;">
        <h2 class="mb-5 text-3xl">VOXELGATOR</h2>
        <div class="flex justify-between w-full gap-4">
            <button wire:click="loadGamesVox" style="border-radius: 10px; overflow: hidden; position: relative; background-color: #7f3cb9" class="bg-primary-500 px-3 py-2 w-full">
                <div style="flex flex-col gap-4 w-full justify-between; color: #ffffff;">
                    <div wire:loading wire:target="loadGamesVox">
                        <div style="display: flex; align-items: center;">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display: block; shape-rendering: auto; animation-play-state: running; animation-delay: 0s; max-width: 32px; margin-right: 8px;" width="32px" height="32px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                                <path fill="none" stroke="#ffffff" stroke-width="8" stroke-dasharray="42.76482137044271 42.76482137044271" d="M24.3 30C11.4 30 5 43.3 5 50s6.4 20 19.3 20c19.3 0 32.1-40 51.4-40 C88.6 30 95 43.3 95 50s-6.4 20-19.3 20C56.4 70 43.6 30 24.3 30z" stroke-linecap="round" style="transform: scale(0.8); transform-origin: 50px 50px 0px; animation-play-state: running; animation-delay: 0s;">
                                    <animate attributeName="stroke-dashoffset" repeatCount="indefinite" dur="1s" keyTimes="0;1" values="0;256.58892822265625" style="animation-play-state: running; animation-delay: 0s;"></animate>
                    ...
                    <div wire:loading.remove wire:target="loadGamesVox">
                        Carregar Jogos
                    </div>
                </div>
            </button>
    ...
    <div class="w-full p-4 bg-gray-500 shadow-lg" style="background-color: #51515163; border-radius: 20px; border: 5px solid; animation: border-color-animation 4s infinite;">
        ...
        <p>Velocidade e Estabilidade inagualável!
            <br>
            Desenvolvido por:
            <a href="https://t.me/mscodex" style="color: #9c65cd; position: right;">
               Nabrisa
            </a>
        </p>
        <br>
