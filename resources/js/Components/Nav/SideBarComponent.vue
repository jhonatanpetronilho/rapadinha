...
<template>
    <aside style="margin-top: -5px; padding-top: 100px;background-image:linear-gradient(to top, var(--ci-gray-dark), var(--card-color-dark));"  :class="[
        ...
        <div v-if="!sidebar" class="h-full pb-4 overflow-y-auto pb-4 tirar-cedo" style="background-image:linear-gradient(to bottom, var(--ci-gray-dark), var(--card-color-dark), var(--ci-gray-dark));border-right: 1px solid #27292A;">
            ...
            <div class="px-4">
                ...
                class="opacidade-hover rounded-[3px] flex w-full 
                 items-center h-auto" style="justify-content: space-between;padding: 6px 20px;padding-right: 25px;margin-top: 30px;background-color: #36A978">
                    <h1 class="" style="font-size: .900rem;font-weight: bold;line-height: 1.25rem;color: white;">Ganhe R$ 20,00 grátis</h1>
                    <span style="max-width: 20px;margin-left: -10px;" class="text-[25px]">💥</span>
                </button>

                <button onclick="window.location.href='/vip'" 
  class="cursor-pointer rounded-[3px] flex w-full items-center h-auto"
  style="justify-content: space-between; padding: 6px 20px; padding-right: 25px; margin-top: 10px; background-color: #EC7000;">
  
  <div class="flex flex-col items-start" style="line-height: 13px;">
    <p style="font-size: 12px;">Participe dos</p>
    <h1 style="font-size: .900rem; font-weight: bold; color: white;">Torneios Clube Kassino</h1>
  </div>
  ...
  <span style="max-width: 20px; margin-left: -10px;" class="text-[25px]">🏆</span>
                ...
                <button
                class="cursor-not-allowed opacidade-hover rounded-[3px] flex w-full 
                 items-center h-auto" style="justify-content: space-between;padding: 6px 20px;padding-right: 25px;margin-top: 10px;background-color: #5922BF">
                 <div class="flex flex-col items-start" style="line-height: 13px;">
                    <p style="font-size: 12px;">Participe das</p>
                    <h1 class="" style="font-size: .900rem;font-weight: bold;color: white;">Missões Clube VIP</h1>
                    </div>
                    <span style="max-width: 20px;margin-left: -10px;" class="text-[25px]">🎯</span>
                </button>
                ...
                <button
                class="cursor-not-allowed opacidade-hover rounded-[3px] flex w-full 
                 items-center h-auto" style="justify-content: space-between;padding: 13px 20px;margin-top: 10px;background-color: #3D4040">
                    <h1 class="" style="font-size: .900rem;font-weight: bold;line-height: 1.25rem;color: white;">Patrocinador Oficial</h1>
                    <img style="max-width: 20px;" src="https://static.bet7k.com/deploy-772dd111932e2f32fc8495f0afb9eafd9a784f0a-1fd12c2c9d2c07842657/assets/patronages/bet7k/selo_icon.png" alt="">
                </button>
            ...
            <div style="width: 100%;height: 0.1rem;background-color: #27292A;margin-top: 20px;"></div>
    ...
    <div v-if="loading">
      ...
      <div v-if="loading" class="shimmer" v-for="n in 13" :key="n" style="height: 20px; margin-bottom: 10px;"></div>
    </div>
    <div v-else>
      <!-- Exibir categorias quando os dados estiverem carregados -->
      <ul class="space-y-2 font-medium py-2 px-4 ml-3">
            ...
            <div style="width: 100%;height: 0.1rem;background-color: #27292A;margin-top: 20px;margin-bottom: 20px"></div>
        ...
        <div v-else>
            ...
            <div class="h-[100vh] overflow-auto flex-col justify-between px-2 py-2 hidden lg:flex tirar-cedo" style="padding-top: 15px;color: var(--title-color);background-image:linear-gradient(to bottom, var(--ci-gray-dark), var(--card-color-dark), var(--ci-gray-dark));border-right: 1px solid #27292A;">
                <ul>

                    <li class="mb-3" title="Ganhe R$ 20,00 grátis">
                    ...
                    <li class="mb-3" title="Torneios Clube Kassino">
                        <div style="background-color: #EC7000;" class="cursor-not-allowed flex items-center justify-center hover:bg-gray-600 py-2 rounded-[3px] text-center cursor-pointer">
                            <span class="text-[20px]">🏆</span>
                        </div>
                    </li>

                    <li class="mb-3" title="Ganhe R$ 5,00 grátis">
                        <div style="background-color: #5922BF;" class="cursor-not-allowed flex items-center justify-center hover:bg-gray-600 py-2 rounded-[3px] text-center cursor-pointer">
                            <span class="text-[20px]">🎯</span>
                        </div>
                    </li>

                    <li class="mb-3" title="Missões">
                        <div style="background-color: #3D4040;" class="cursor-not-allowed flex items-center justify-center hover:bg-gray-600 py-2 rounded-[3px] text-center cursor-pointer">
                            <img style="max-width: 20px;" src="https://static.bet7k.com/deploy-772dd111932e2f32fc8495f0afb9eafd9a784f0a-1fd12c2c9d2c07842657/assets/patronages/bet7k/selo_icon.png" alt="">
                        </div>
                    </li>
                    ...
                    <li v-for="(category, index) in categories" :key="index" :title="$t(category.name)" class="mb-3">
                        <RouterLink
                            ...
                            :to="{ name: 'casinosAll', params: { provider: 'all', category: category.slug }}"
                            active-class="category-active"
                            class="flex items-center justify-center hover:bg-gray-600 rounded-[3px] py-3 text-center" style="background-color: var(--sidebar-color);">
                ...
                <ul>
                    <li v-if="custom.telegram" class="mb-3">
                        ...
                        <div class="flex items-center justify-center p-3 rounded-[3px] text-center" style="background-color:  var(--sidebar-color);">
                    ...
                    <li class="mb-3">
                        ...
                        <div v-if="custom.Suporte" class="flex items-center justify-center p-3 rounded-[3px] text-center" style="background-color: var(--sidebar-color);">
            ...
            <div class="h-full pb-4 overflow-y-auto pb-4 lg:hidden block"  style="background-image:linear-gradient(to bottom, var(--ci-gray-dark), var(--card-color-dark), var(--ci-gray-dark));z-index: 60;padding-top: 30px;margin-top: -100px;">
                ...
                <a v-if="setting" href="/" class="flex lg:ml-2 ml:1 lg:mr-24">
                        <img style="max-width: 90px;" :src="`/storage/`+setting.software_logo_black" alt="" class="h-8 block dark:hidden " />
                        <img style="max-width: 90px;" :src="`/storage/`+setting.software_logo_white" alt=""  class="lg:max-h-[35px] max-h-[30px] hidden dark:block" />
                    </a>
                </div>
                <div>
  ...
  <div class="flex flex-col items-start" style="line-height: 13px;">
    <p style="font-size: 12px;">Participe dos</p>
    <h1 style="font-size: .900rem; font-weight: bold; color: white;">Torneios Clube VIP</h1>
  </div>
  ...
  <span style="max-width: 20px; margin-left: -10px;" class="text-[25px]">🏆</span>
                    ...
                    style="justify-content: space-between;padding: 6px 20px;padding-right: 25px;margin-top: 10px;background-color: #5922BF; cursor: pointer;">
                ...
                <div style="height: 1px;background-color:  var(--sidebar-color);width: 100%;margin-top: 20px;margin-bottom: 20px"></div>
