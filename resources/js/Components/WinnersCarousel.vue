<template>
  <div class="main-container">
    <!-- SVG com tamanhos responsivos reduzidos -->
    <svg viewBox="0 0 59 60" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-12 sm:w-16 lg:w-20 flex-shrink-0">
        <defs>
            <filter id="filter0_d_726_17235" x="31.25" y="12.25" width="15.5" height="15.5" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                ...
                <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_726_17235"></feBlend>
                <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_726_17235" result="shape"></feBlend>
            </filter>
        </defs>
    ...
    <swiper
      ...
      class="w-full"
    >
      <swiper-slide v-for="(winner, index) in winners" :key="index" class="item-card">
        <!-- Imagem e textos reduzidos -->
        <img :src="winner.image" class="w-8 h-8 object-contain flex-shrink-0" :alt="winner.item" onerror="this.style.display='none'">
        <div class="flex flex-col text-xs overflow-hidden">
          <span class="font-bold text-[#FFC700] text-nowrap text-ellipsis">{{ winner.name }}</span>
          <h1 class="font-medium text-[#CCCCCC] text-nowrap text-ellipsis">{{ winner.item }}</h1>
          <span class="font-bold">
            <span class="text-[#00E0C7]">R$ </span>
            <span class="text-white">{{ winner.price }}</span>
          </span>
        </div>
      </swiper-slide>
    </swiper>
...
<script setup>
// Importações necessárias do Swiper e Vue
import { ref } from 'vue';
...
// Lista de ganhadores como um array reativo
const winners = ref([
  { name: 'Verônica Sa******', item: 'Micro-ondas', price: '1.000,00', image: 'https://ik.imagekit.io/azx3nlpdu/item_micro_ondas_flat.png?updatedAt=1751634890350' },
  { name: 'Ornela Ca******', item: 'Capinha para iPhone 15', price: '30,00', image: 'https://ik.imagekit.io/azx3nlpdu/item_capinha_trasparente_iphone_15_pro_max.png?updatedAt=1751634896274' },
  { name: 'Mia Co*****', item: 'Nissan Kicks', price: '115.000,00', image: 'https://ik.imagekit.io/azx3nlpdu/banner/01K0BEBYS7BN26DVZ0SHQJV8TT.png' },
  { name: 'Sônia Co****', item: 'PowerBank', price: '60,00', image: 'https://ik.imagekit.io/azx3nlpdu/banner/01K0F5KTMSEJBQF1STFZ4BCKXM.png' },
  { name: 'Lucas Se***', item: 'Lava-louças', price: '4.000,00', image: 'https://ik.imagekit.io/azx3nlpdu/item_lava_lou_a_samsung.png?updatedAt=1751634890781' },
  { name: 'Jasmin Pe***', item: 'Fone de ouvido Lenovo', price: '220,00', image: 'https://ik.imagekit.io/azx3nlpdu/item_fone_de_ouvido_lenovo.png?updatedAt=1751634891006' },
  { name: 'Arthur Ji*****', item: '5 Reais', price: '5,00', image: 'https://ik.imagekit.io/azx3nlpdu/Notas/5%20REAIS.png?updatedAt=1752047821734' },
  { name: 'Maria To****', item: 'Datejust 41', price: '75.400,00', image: 'https://ik.imagekit.io/azx3nlpdu/banner/01K0BEQH30DBZPFNJNQP2W7V5D.png' },
  { name: 'Joaquim Ca*****', item: '0,50 Centavos', price: '0,50', image: 'https://ik.imagekit.io/azx3nlpdu/50-CENTAVOS-2.png?updatedAt=1752864509979' },
  { name: 'Thomas Ve**', item: 'Notebook Dell G15', price: '4.500,00', image: 'https://ik.imagekit.io/azx3nlpdu/item_notebook_g15.png?updatedAt=1751634891010' },
  { name: 'Thalia Ga******', item: 'Camisa Nike Brasil I 2022/23', price: '350,00', image: 'https://ik.imagekit.io/azx3nlpdu/item_camisa_nike_brasil_i_2022_23_torcedor_pro.png?updatedAt=1751634896257' },
  { name: 'Victor Uc***', item: 'Controle Xbox (Electric Volt)', price: '500,00', image: 'https://ik.imagekit.io/azx3nlpdu/item_controle_xbox_eletric_volt.png?updatedAt=1751634897634' },
]);
</script>

<style scoped>
/* Estilos gerais e personalizados para combinar com o exemplo */
.main-container {
  display: flex;
  align-items: center;
  gap: 0.5rem; /* 8px para mobile */
  width: 100%;
  position: relative;
}

/* Card do item com largura responsiva */
.item-card {
  display: flex;
  align-items: center;
  gap: 0.5rem; /* 8px */
  ...
  width: 10rem !important; /* 160px para mobile */
  background-color: #2B2B2B;
  box-sizing: border-box;
}

/* Garante que o swiper não tenha overflow visível */
.swiper {
  overflow: hidden;
  width: 100%;
}

/* Media Query para telas 'sm' (small) e maiores (min-width: 640px) */
@media (min-width: 640px) {
  .main-container {
    gap: 1rem; /* 16px para telas maiores */
  }

  .item-card {
    width: 11rem !important; /* 176px para telas maiores */
  }
}
</style>
