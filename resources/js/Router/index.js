...
import ScratchHome from "@/Pages/ScratchCard/ScratchHome.vue";
import ScratchGame from "@/Pages/ScratchCard/ScratchGame.vue";
...
import UserAccount from "@/Pages/Auth/UserAccount.vue";
import CountdownTimer from "@/Pages/Home/CountdownTimer.vue";

// Caso queira acessar o Home antigo em /inicio, descomente abaixo
...
export const routes = [
    ...
    },
  {
    ...
    },
    {
        name: 'casinos',
        path: '/casinos',
        // component: HomePage // HomePage REMOVIDO DA ROTA PRINCIPAL
        component: ScratchHome // ou use outra página se preferir
    },
    {
        name: 'casinoPlayPage',
