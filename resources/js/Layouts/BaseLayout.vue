<template>
  <div class="min-h-screen flex flex-col bg-[#171717]">
    ...
    <div
      :class="[ sidebar === true ? 'lg:ml-[65px]' : 'lg:ml-[280px]']"
    ...
    <!-- FOOTER E BOTTOM NAV FORA DO CONTAINER DE MARGEM -->
    <FooterComponent v-once />
    <BottomNavComponent v-once />

    <!-- Mission Modal (sem alteração) -->
    <div id="modalMissionEl" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
      ...
      <div class="relative p-4 w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-green-700">
            ...
            <button @click.prevent="toggleMissionModal" type="button"
          ...
          <div class="p-4 md:p-5 space-y-4 top-custom">
            ...
            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
              <ul class="flex justify-between -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400" id="tabs-mission" role="tablist">
                <li class="me-2 w-full" role="presentation">
                  <button class="w-full inline-block rounded-t-lg border-b-2 border-transparent p-4 hover:border-gray-300 hover:text-gray-600 dark:hover:text-gray-300"
                    id="daily-mission-tab" type="button" role="tab" aria-controls="daily-mission" aria-selected="false">
                    {{ $t('Daily Missions') }}
                  </button>
                </li>
                <li class="me-2 w-full" role="presentation">
                  <button class="w-full inline-block rounded-t-lg border-b-2 border-transparent p-4 hover:border-gray-300 hover:text-gray-600 dark:hover:text-gray-300"
                    id="weekly-tasks-tab" type="button" role="tab" aria-controls="weekly-tasks" aria-selected="false">
                    {{ $t('Weekly Tasks') }}
                  </button>
                </li>
              </ul>
            ...
            <div id="tabContentExample">
              <div class="hidden rounded-lg bg-gray-50 p-4 dark:bg-gray-800" id="daily-mission" role="tabpanel" aria-labelledby="daily-mission-tab">
                <MissionDaily/>
              </div>
              <div class="hidden rounded-lg bg-gray-50 p-4 dark:bg-gray-800" id="weekly-tasks" role="tabpanel" aria-labelledby="weekly-tasks-tab">
                <MissionWeekly />
              </div>
            </div>
          </div>
...
// import SideBarComponent from "@/Components/Nav/SideBarComponent.vue"; // REMOVIDO
