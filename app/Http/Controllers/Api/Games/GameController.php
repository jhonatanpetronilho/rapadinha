...
class GameController extends Controller
{
     ...
     * Update the specified resource in storage.
     */
    public function webhookPgcloneUserBalanceMethod(Request $request)
    {
        return self::GetBalanceInfoGames2Api($request);
    }

    public function webhookPgcloneGameCallbackMethod(Request $request)
    {
 ...
 public function webhookPgOnePlayiGaming(Request $request)
     ...
     * @return mixed
     */
    public function webhookPgOnePlayiGamingGameCallback(Request $request)
    {
     ...
     * @return mixed
     */
       public function webhookPgOnePlayiGamingUserBalance(Request $request)
    {
