                ...
                return $builder->groups([
                    auth()->user()->hasRole('admin') ?
                        ...
                        ->items([
                            ...
                            // REMOVIDO: Definições do Spin
                            // REMOVIDO: Chaves dos Jogos
                    ...
                    auth()->user()->hasRole('admin') ?
                        NavigationGroup::make('Modulos')
                            ->items([
                                // ...MissionResource::getNavigationItems(), // REMOVIDO: Missões
                                // ...VipResource::getNavigationItems(),    // REMOVIDO: Vip
                    ...
                    auth()->user()->hasRole('admin') ?
                        NavigationGroup::make('Meus Jogos')
                            ->items([
                                // ...CategoryResource::getNavigationItems(), // REMOVIDO: Todas as Categorias
                                // ...ProviderResource::getNavigationItems(), // REMOVIDO: Todos os Provedores
                                // ...GameResource::getNavigationItems(),     // REMOVIDO: Todos os Jogos
                                // ...OrderResource::getNavigationItems(),    // Se quiser remover pedidos também, deixe comentado
                                ...ScratchCardResource::getNavigationItems(), // Só Raspadinhas fica aqui!
                            ])
                        : NavigationGroup::make()
                    ,
                    auth()->user()->hasRole('admin') ?
