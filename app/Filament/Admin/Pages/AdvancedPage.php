...
{
    use PlayConnectTrait, PgOnePlayiGamingTrait, InteractsWithForms, DrakonTrait, WorldSlotTrait, WithFileUploads, EvergameTrait, PlayGamingTrait;
 ...
 public function loadGamesPgOnePlayiGaming()
    {
        self::GetGamesListPgOnePlayiGaming();
        Notification::make()
            ->title('Sucesso')
            ->body('Jogos Carregados com sucesso')
            ->success()
    ...
    public function loadProviderPgOnePlayiGaming()
     {
         self::getPgOnePlayiGamingProvider();
         Notification::make()
             ->title('Sucesso')
             ->body('Provedores Carregados com sucesso')
             ->success()
     ...
     * @return void
    */
    public function loadGamesPlayGaming()
    {
