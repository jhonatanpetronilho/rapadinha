                ...
                Action::make('approve_payment')
                    ...
                    ->action(function(Withdrawal $withdrawal) {
                        \Filament\Notifications\Notification::make()
                            ...
                            ->send();
                            \Helper::CreateReport('Enviou um pagamento', 'O Administrador '. auth()->user()->name. ' Pagou um saque de R$'. $withdrawal->amount.  ' para o usuário '. $withdrawal->user_name . ' na chave pix: '. $withdrawal->pix_key. ' '. $withdrawal->pix_type. ' ID DE TRANSAÇÃO: '. $withdrawal->id );
