...
class SettingResource extends Resource
{
    ...
    public static function sidebar(Model $record): FilamentPageSidebar
    {
        ...
        return FilamentPageSidebar::make()
            ...
            ->setNavigationItems([
                ...
                PageNavigationItem::make('ADS')
                    ->translateLabel()
                    ->url(static::getUrl('ads', ['record' => $record->id]))->icon('heroicon-o-arrow-trending-up')
                    ->isActiveWhen(function () {
                        return request()->routeIs(static::getRouteBaseName() . '.ads');
                    }),
            ]);
    }
    ...
    public static function getPages(): array
    {
        ...
        return [
            ...
            'ads' => \App\Filament\Admin\Resources\SettingResource\Pages\AdsPage::route('/ads/{record}'),
        ];
    }
}
